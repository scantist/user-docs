...
```bash
java -jar sca-bom-detect.jar -gradleScope scope1,scope2,scope3
```
...
```bash
java -jar sca-bom-detect.jar -gradleScope implementation,compile,kotlinCompilerClasspath,kapt,testImplementation
```
