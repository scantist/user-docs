...
> Discover {{companyConfig.COMPANY_NAME}}'s capabilities with CircleCI integration
...
Integrating {{companyConfig.COMPANY_NAME}} into the development lifecycle of CircleCI can help enforce security and licensing compliance within your CI/CD pipeline.

Follow these steps to integrate {{companyConfig.COMPANY_NAME}} with CircleCI:

<ol>
<li>Create access token</li>

You will need to create an access token on {{companyConfig.COMPANY_NAME}} to authenticate and authorize the integration between {{companyConfig.COMPANY_NAME}} and CircleCI.
...
jobs:
  ...
  build-and-test:
    ...
    steps:
      ...
      # Then run your {{companyConfig.COMPANY_NAME}} scan!
      - run:
          name: {{companyConfig.COMPANY_NAME}}-scan
...
This command will call the {{companyConfig.COMPANY_NAME}} Circle script to receive your successfully built result from CircleCI. After the successful build, the third-party component information of your project will be pushed to {{companyConfig.COMPANY_NAME}} SCA.
